...
export const COUNTRIES: Country[] = [
    { id: 'USA', name: 'United States', taxRate: 0.21, companyCostModifier: 1.0, localMarkets: ['AAPL', 'GOOGL', 'MSFT', 'AMZN', 'TSLA', 'NVDA', 'PFE', 'MRNA', 'JNJ', 'CAT', 'PG', 'NY_RealEstate'], immigrationCost: 10000000, politicalParties: [{id: 'dems', name: 'Democrats'}, {id: 'gop', name: 'Republicans'}] },
    ...
    { id: 'DEU', name: 'Germany', taxRate: 0.30, companyCostModifier: 1.2, localMarkets: ['VOW3_DE', 'SIE_DE'], immigrationCost: 8000000, politicalParties: [{id: 'cdu', name: 'CDU/CSU'}, {id: 'spd', name: 'SPD'}] },
    ...
    { id: 'IND', name: 'India', taxRate: 0.22, companyCostModifier: 0.6, localMarkets: ['TTM'], immigrationCost: 5000000, politicalParties: [{id: 'bjp', name: 'BJP'}, {id: 'inc', name: 'Congress'}] },
    { id: 'RUS', name: 'Russia', taxRate: 0.20, companyCostModifier: 0.8, localMarkets: [], immigrationCost: 15000000, politicalParties: [{id: 'ur', name: 'United Russia'}] },
    { id: 'FRA', name: 'France', taxRate: 0.28, companyCostModifier: 1.3, localMarkets: ['LVMUY'], immigrationCost: 9000000, politicalParties: [{id: 'rem', name: 'La République En Marche!'}, {id: 'rn', name: 'National Rally'}] },
    { id: 'KOR', name: 'South Korea', taxRate: 0.25, companyCostModifier: 0.9, localMarkets: ['SSNLF'], immigrationCost: 11000000, politicalParties: [{id: 'dp', name: 'Democratic Party'}, {id: 'ppp', name: 'People Power Party'}] },
    { id: 'NLD', name: 'Netherlands', taxRate: 0.25, companyCostModifier: 1.2, localMarkets: ['ASML'], immigrationCost: 10000000, politicalParties: [{id: 'vvd', name: 'VVD'}] },
    { id: 'CHE', name: 'Switzerland', taxRate: 0.18, companyCostModifier: 1.5, localMarkets: ['RHHBY', 'NVS'], immigrationCost: 25000000, politicalParties: [{id: 'svp', name: 'SVP'}] },
    { id: 'CAN', name: 'Canada', taxRate: 0.26, companyCostModifier: 1.1, localMarkets: ['VAN_RealEstate'], immigrationCost: 7000000, politicalParties: [{id: 'lib', name: 'Liberal'}, {id: 'con', name: 'Conservative'}] },
    { id: 'ARE', name: 'UAE', taxRate: 0.09, companyCostModifier: 1.4, localMarkets: ['DBI_RealEstate', 'SAOC'], immigrationCost: 18000000, politicalParties: [{id: 'monarchy', name: 'Monarchy'}] },
];
...
export const getInitialState = (): GameState => {
    ...
    return {
        ...
        player: {
            ...
            marginPositions: {},
            companies: [],
            loan: { amount: 0, interestRate: 0.05 },
            politicalCapital: {},
