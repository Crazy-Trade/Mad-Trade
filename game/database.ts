...
export const COUNTRIES: Country[] = [
    ...
    { id: 'TWN', name: 'Taiwan', taxRate: 0.20, companyCostModifier: 1.0, localMarkets: ['TSM', 'MEDIATEK'], immigrationCost: 14000000, politicalParties: [{id: 'dpp', name: 'DPP'}, {id: 'kmt', name: 'KMT'}] },
...
const ASSETS_LIST: Omit<Asset, 'priceHistory' | 'dayOpen' | 'dayHigh' | 'dayLow'>[] = [
    ...
    { id: 'BARRICK', name: 'Barrick Gold', category: 'Commodity', price: 17, basePrice: 17, volatility: 0.035, trend: 0.0001, dna: { globalStability: -1.2, usFedPolicy: -1.0, inflation: 0.8 } },
    ...
    { id: 'BIDU', name: 'Baidu', category: 'Tech', price: 150, basePrice: 150, volatility: 0.04, trend: 0.0003, dna: { chinaEconomy: 1.2, techInnovation: 0.9, secRegulation: -0.8 } },
    { id: 'SONY', name: 'Sony Group', category: 'Tech', price: 110, basePrice: 110, volatility: 0.025, trend: 0.0002, dna: { japanEconomy: 1.0, publicSentiment: 0.6, globalSupplyChain: -0.4 } },
    { id: 'NTDOY', name: 'Nintendo', category: 'Tech', price: 60, basePrice: 60, volatility: 0.03, trend: 0.0003, dna: { japanEconomy: 0.8, publicSentiment: 1.2, techInnovation: 0.5 } },
    { id: 'INFY', name: 'Infosys', category: 'Tech', price: 20, basePrice: 20, volatility: 0.028, trend: 0.0004, dna: { indiaEconomy: 1.5, usEconomy: 0.6, techInnovation: 0.4 } },
    { id: 'MEDIATEK', name: 'MediaTek', category: 'Tech', price: 35, basePrice: 35, volatility: 0.032, trend: 0.0005, dna: { techInnovation: 1.8, globalSupplyChain: -1.2, asiaTensions: -0.8 } },
    ...
    { id: 'BAYN', name: 'Bayer AG', category: 'Pharma', price: 55, basePrice: 55, volatility: 0.02, trend: 0, dna: { pharmaDemand: 0.8, euEconomy: 0.6, secRegulation: -0.5 } },
    { id: 'AZN', name: 'AstraZeneca', category: 'Pharma', price: 65, basePrice: 65, volatility: 0.019, trend: 0.0001, dna: { pharmaDemand: 1.4, euEconomy: 0.5 } },
    { id: 'SNY', name: 'Sanofi', category: 'Pharma', price: 100, basePrice: 100, volatility: 0.018, trend: 0.0001, dna: { pharmaDemand: 1.3, euEconomy: 0.6 } },
    ...
    { id: 'SAOC', name: 'Saudi Aramco', category: 'Global', price: 11, basePrice: 11, volatility: 0.02, trend: 0.0001, dna: { oilSupply: 1.8, middleEastTension: -1.2, globalStability: 0.4 }, isStateOwned: true },
    ...
    { id: 'HSBC', name: 'HSBC Holdings', category: 'Finance', price: 30, basePrice: 30, volatility: 0.022, trend: 0.0001, dna: { globalStability: 1.0, usEconomy: 0.6, chinaEconomy: 0.8, euEconomy: 0.7, usFedPolicy: -0.5 } },
    { id: 'PBR', name: 'Petrobras', category: 'Global', price: 15, basePrice: 15, volatility: 0.04, trend: 0, dna: { oilSupply: -1.2, globalStability: -0.7 }, isStateOwned: true },
    { id: 'RUS_SCAM', name: 'Gazprom Invest', category: 'Global', price: 2, basePrice: 2, volatility: 0.35, trend: 0.005, dna: { russiaEconomy: 1.5, publicSentiment: 0.5, globalStability: -1.0 }, isScam: true, isStateOwned: true },
    { id: 'TTE', name: 'TotalEnergies SE', category: 'Global', price: 55, basePrice: 55, volatility: 0.026, trend: 0.0001, dna: { oilSupply: -1.6, euEconomy: 0.6, climateChangeImpact: -0.8 }, isStateOwned: true },
    { id: 'UBS', name: 'UBS Group AG', category: 'Finance', price: 18, basePrice: 18, volatility: 0.024, trend: 0.0001, dna: { globalStability: 1.2, euEconomy: 0.8, usFedPolicy: 0.6 } },
    { id: 'ALV', name: 'Allianz SE', category: 'Finance', price: 220, basePrice: 220, volatility: 0.018, trend: 0.0001, dna: { globalStability: 1.0, euEconomy: 1.2, climateChangeImpact: -0.5 } },
    { id: 'CBA', name: 'Commonwealth Bank', category: 'Finance', price: 100, basePrice: 100, volatility: 0.02, trend: 0.0002, dna: { globalStability: 0.8, chinaEconomy: -0.6 } },
    { id: 'SBER', name: 'Sberbank', category: 'Finance', price: 3, basePrice: 3, volatility: 0.1, trend: 0.0001, dna: { russiaEconomy: 2.0, globalStability: -1.5 }, isStateOwned: true },
    { id: 'INGA', name: 'ING Groep', category: 'Finance', price: 12, basePrice: 12, volatility: 0.025, trend: 0.0001, dna: { euEconomy: 1.1, usFedPolicy: 0.5 } },
    ...
    { id: 'NIO', name: 'NIO Inc.', category: 'Industrial', price: 20, basePrice: 20, volatility: 0.08, trend: 0.0006, dna: { techInnovation: 1.2, chinaEconomy: 1.0, publicSentiment: 0.8, oilSupply: 0.4 } },
    { id: 'VOW3_DE', name: 'Volkswagen AG', category: 'Industrial', price: 180, basePrice: 180, volatility: 0.022, trend: 0, dna: { euEconomy: 1.2, globalSupplyChain: -0.7, oilSupply: -0.3 }, isStateOwned: true },
    { id: 'TTM', name: 'Tata Motors', category: 'Industrial', price: 30, basePrice: 30, volatility: 0.03, trend: 0.0003, dna: { indiaEconomy: 1.5, globalSupplyChain: -0.4 } },
    { id: 'RIO', name: 'Rio Tinto', category: 'Industrial', price: 70, basePrice: 70, volatility: 0.03, trend: 0.0002, dna: { chinaEconomy: 1.6, globalSupplyChain: -0.7 } },
    { id: 'VALE', name: 'Vale S.A.', category: 'Industrial', price: 14, basePrice: 14, volatility: 0.045, trend: 0.0001, dna: { chinaEconomy: 1.8, globalSupplyChain: -0.8 } },
    { id: 'LG', name: 'LG Corp', category: 'Industrial', price: 75, basePrice: 75, volatility: 0.027, trend: 0.0002, dna: { asiaTensions: -0.6, globalSupplyChain: -0.9, techInnovation: 0.6 } },
    { id: 'HYMTF', name: 'Hyundai Motor', category: 'Industrial', price: 45, basePrice: 45, volatility: 0.028, trend: 0.0002, dna: { globalSupplyChain: -0.7, asiaTensions: -0.4, usEconomy: 0.5 } },
    ...
    { id: 'NESN', name: 'Nestlé S.A.', category: 'Consumer', price: 120, basePrice: 120, volatility: 0.013, trend: 0.0001, dna: { globalStability: 0.5, euEconomy: 0.6, inflation: -0.25 } },
];
